...
(function () {
    ...
    /* ══════════════════════════════════════════════════
       ...
       ══════════════════════════════════════════════════ */
    function fetchIQAir() {
        var url = "https://api.airvisual.com/v2/city?city=Tashkent&state=Tashkent&country=Uzbekistan&key=" + CONFIG.IQAIR_KEY;
        return safeFetch(url)
            .then(function (json) {
                ...
                log("IQAir: AQI=" + p.aqius + " | Main pollutant=" + p.mainus + " | Humidity=" + w.hu + "%");
                return {
                    source: "IQAir",
                    aqi: p.aqius,
